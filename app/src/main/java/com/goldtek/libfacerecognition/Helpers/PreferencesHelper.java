...
public class PreferencesHelper {
    ...
    public String getClassificationMethod(){
        return sharedPreferences.getString("key_classification_method", resources.getString(R.string.tensorflow));
    }
    ...
    public float getGamma(){
        return Float.valueOf(sharedPreferences.getString("key_gamma", resources.getString(com.goldtek.recognitionsvr.R.string.gamma)));
    }

    public  double[] getSigmas(){
        String[] sigmasString = sharedPreferences.getString("key_sigmas", resources.getString(com.goldtek.recognitionsvr.R.string.sigmas)).split(",");
        if(sigmasString.length != 2){
            sigmasString = resources.getString(com.goldtek.recognitionsvr.R.string.sigmas).split(",");
        }
    ...
    public String getCaffeModelFile(){
        return sharedPreferences.getString("key_modelFileCaffe", resources.getString(com.goldtek.recognitionsvr.R.string.modelFileCaffe));
    }

    public String getCaffeWeightsFile(){
        return sharedPreferences.getString("key_weightsFileCaffe", resources.getString(com.goldtek.recognitionsvr.R.string.weightsFileCaffe));
    }

    public String getCaffeOutputLayer(){
        return sharedPreferences.getString("key_outputLayerCaffe", resources.getString(com.goldtek.recognitionsvr.R.string.weightsFileCaffe));
    }

    public float[] getCaffeMeanValues(){
        String[] meanValuesString = sharedPreferences.getString("key_meanValuesCaffe", resources.getString(com.goldtek.recognitionsvr.R.string.meanValuesCaffe)).split(",");
        if(meanValuesString.length != 3){
            meanValuesString = resources.getString(com.goldtek.recognitionsvr.R.string.meanValuesCaffe).split(",");
        }
    ...
    public String getFaceCascadeFile(){
        return sharedPreferences.getString("key_face_cascade_file", resources.getString(com.goldtek.recognitionsvr.R.string.haarcascade_alt2));
    }

    public String getLefteyeCascadeFile(){
        return sharedPreferences.getString("key_lefteye_cascade_file", resources.getString(com.goldtek.recognitionsvr.R.string.haarcascade_lefteye));
    }

    public String getRighteyeCascadeFile(){
        return sharedPreferences.getString("key_righteye_cascade_file", resources.getString(com.goldtek.recognitionsvr.R.string.haarcascade_righteye));
    }
