...
import com.goldtek.recognitionsvr.Common;
...
public class FileHelper {
    ...
    private static String FOLDER_PATH = "";//Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/facerecognition";
    ...
    public FileHelper(){
        this.FOLDER_PATH = Common.m_szExtAppPath;
        this.TRAINING_PATH = FOLDER_PATH + "/training/";
        this.TEST_PATH        = FOLDER_PATH + "/test/";
        this.DETECTION_TEST_PATH = FOLDER_PATH + "/detection_test/";
        this.DATA_PATH        = FOLDER_PATH + "/data/";
        this.RESULTS_PATH     = FOLDER_PATH + "/results/";
        this.EIGENFACES_PATH  = DATA_PATH + "Eigenfaces/";
        this.SVM_PATH         = DATA_PATH + "SVM/";
        this.KNN_PATH         = DATA_PATH + "KNN/";
        this.CAFFE_PATH       = DATA_PATH + "Caffe/";
        this.TENSORFLOW_PATH  = DATA_PATH + "TensorFlow/";
    }
