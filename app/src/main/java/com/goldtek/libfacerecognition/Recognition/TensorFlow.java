...
//                                return Float.compare(rhs, lhs);
//                            }
//                        });
//
//        Log.e(TAG, "Output Length: " + String.valueOf(outputs.length));
//        for (int i = 0; i < outputs.length; ++i) {
//            if (outputs[i] > THRESHOLD) {
//                pq.add(outputs[i]);
//
//                String szPercentage = String.format("(%.1f%%) ", outputs[i] * 100.0f);
//                Log.e(TAG, "Percentage: " + szPercentage);
//            }
//        }
//
//        int recognitionsSize = Math.min(pq.size(), MAX_RESULTS);
//        Log.e(TAG, "recognitionsSize: " + String.valueOf(recognitionsSize));
